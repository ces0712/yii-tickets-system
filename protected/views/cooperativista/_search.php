...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'id_tipo_cooperativa'); ?>
		<?php echo $form->dropDownList($model, 'id_tipo_cooperativa', GxHtml::listDataEx(TipoCooperativa::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
